#Starting with fastq files with this names TUM1_S1_L005_R1_001.fastq.gz  TUM1_S1_L005_R2_001.fastq.gz
...
#	Sort files and convert to bam files PE
...
#	Sort files and convert to bam files  SE
